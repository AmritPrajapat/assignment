/*
Q.4:Create a class named Employee that contains properties for the name,color and birth year.Include get and set methods 
for these fields.Create a subclass named AdhocEmployee, which contains an additional 
field  that holds the number of hours he worked on and also write set and get method for the new field.
